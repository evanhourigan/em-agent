...
class ApprovalProposalRequest(BaseModel):
    ...
    def validate_action(cls, v):
        ...
        allowed_actions = {
            'deploy', 'merge', 'block', 'nudge',
            'comment_summary', 'assign_reviewer', 'escalate'
        }
...
class ApprovalResponse(BaseModel):
    ...
    status: str = Field(..., description="Current status (pending, approve, decline, modify)")
    reason: Optional[str] = Field(None, description="Reason or rationale")
...
class ApprovalProposalResponse(BaseModel):
    ...
    proposed: ApprovalProposalRequest = Field(..., description="The proposed approval data")
...
class ApprovalDecisionResponse(BaseModel):
    ...
    job_id: Optional[int] = Field(None, description="Workflow job ID if created")
